...
| public.sync_profile_from_auth(user_uuid UUID)                                                  | Manually syncs profile data for a given user from auth.users; logs activity                                 | public.profiles                                                        | public.log_user_activity                            |
...
| public.is_admin(p_user_id UUID)                                                                | Returns true if the profile has account_type = 'admin'                                                      | None                                                                   | None                                                |
