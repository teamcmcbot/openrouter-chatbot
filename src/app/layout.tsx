        ...
        <AuthProvider>
          <ErrorBoundary>
            ...
            <div className="flex flex-col h-mobile-screen">
              <nav className="sticky top-0 z-50 border-b border-slate-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-gray-800 dark:bg-gray-900/80 shadow-sm flex-shrink-0">
